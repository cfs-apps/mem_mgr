...
#define  MEM_MGR_MAJOR_VER   3
#define  MEM_MGR_MINOR_VER   1
...
#define CFG_MEM_DWELL_EXEC_TOPICID       BC_SCH_1_HZ_TOPICID         // Use different CFG_ name instead of BC_SCH_4_SEC_TOPICID to localize impact if rate changes
...
#define CFG_MEM_DWELL_PIPE_NAME        MEM_DWELL_PIPE_NAME
#define CFG_MEM_DWELL_PIPE_DEPTH       MEM_DWELL_PIPE_DEPTH
#define CFG_MEM_DWELL_TBL_LOAD_FILE    MEM_DWELL_TBL_LOAD_FILE
#define CFG_MEM_DWELL_CHILD_NAME       MEM_DWELL_CHILD_NAME
#define CFG_MEM_DWELL_CHILD_STACK_SIZE MEM_DWELL_CHILD_STACK_SIZE
#define CFG_MEM_DWELL_CHILD_PRIORITY   MEM_DWELL_CHILD_PRIORITY
#define CFG_MEM_DWELL_CHILD_PERF_ID    MEM_DWELL_CHILD_PERF_ID
...
#define APP_CONFIG(XX) \
   ...
   XX(MEM_DWELL_PIPE_NAME,char*) \
   XX(MEM_DWELL_PIPE_DEPTH,uint32) \
   XX(MEM_DWELL_TBL_LOAD_FILE,char*) \
   XX(MEM_DWELL_CHILD_NAME,char*) \
   XX(MEM_DWELL_CHILD_STACK_SIZE,uint32) \
   XX(MEM_DWELL_CHILD_PRIORITY,uint32) \
   XX(MEM_DWELL_CHILD_PERF_ID,uint32)
